...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($news as $item)
                            <tr>
                                ...
                                <td ><img src="../assets/News/{{$item->cover}}" alt="" width="50px"></td>

                                <td style="width: 400px">{{$item->descriptions}}</td>
                                <td>{{$item->viewer}}</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('goUpdateNews',['id'=>$item->id])}}"
                                                data-value='{{ $item->name}}' data-id={{$item->id}} id="update_news_key"><i
                                                    class="bx bx-edit-alt me-1"></i>
                                                Edit</a>
                                            <a class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#delete_modal" href="javascript:void(0);"
                                                data-value="{{ $item->id }}" id="remove_news_key"><i
        ...
        {{-- delete modal --}}
        <div class="mt-3">
            <form action="/dashboard/delete_news" method="post" enctype="multipart/form-data">
                @csrf
                @method('Delete')
